    ...
    return (
        <div className='bg-[#f3f3f3] flex justify-center px-4 pb-10 py-4 pt-10'>
            ...
            border border-gray-200 py-8 px-3 text-center'>
                ...
                <p className='text-gray-500 text-sm max-w-xl mx-auto'>AI-powered interview preparation platform 
                designed to improve communication skills,technical
                depth and professional confidence.</p>
            </div>
        </div>
    )
}
