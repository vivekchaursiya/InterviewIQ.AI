...
import { FaArrowLeft, FaRegLaugh } from "react-icons/fa";
...
const Step3Report = ({ report }) => {
    ...
    if (!report) {
        return (
        <div className="min-h-screen h-[50vh] sm:h-screen flex items-center justify-center">
            <Loader />
        </div>
        );
    }
...
shortTagline = "Work on clarity and significant";
}
...
doc.setFontSize(12);
doc.text(`Confidence: ${confidence}`,margin + 10,currentY + 18);
...
if (finalScore >= 8) {
    ...
    advice = `Good foundation shown. Improve clarity and structure. Practice delivering confident answers with stronger supporting examples.`;
    ...
    autoTable(doc,{
        ...
        columnStyles:{
            0: {cellWidth:10,halign:"center" ,valign:"top"}, //index
            1: {cellWidth:55,valign:"top"}, //question
...
<div
    ...
    to-emerald-50 px-4 sm:px-6 lg:px-10 py-8"
>
    <div
    className="mb-8 flex flex-col sm:flex-row sm:items-center
        sm:justify-between gap-4"
    >
    <div className="md:mb-10 w-full flex flex-wrap items-start gap-4">
        <button
    ...
    onClick={downloadPDF}
        className="bg-emerald-600 hover:bg-emerald-700 text-white
            ...
            text-sm sm:text-base px-3 cursor-pointer text-nowrap flex flex-row gap-1 justify-center"
    >
        Download
    ...
    <div className="space-y-6">
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="bg-white rounded-3xl sm:rounded-3xl shadow-lg
                p-6 sm:p-8"
        >
    ...
    <div className="lg:col-span-2 space-y-6">
        ...
        className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5
                sm:p-8"
        >
        <h3 className="text-base sm:text-gray-700 mb-6">
            Question Breakdown
        </h3>
        <div className="space-y-6">
            ...
            >
                ...
                <div
                className="bg-green-50 border border-green-200 p-4
                                rounded-lg"
                >
