...
<div className="min-h-screen bg-body flex flex-col">
    <Navbar/>
    <div className="flex-1 px-6 py-20 bg-[#F3F3F3]">
    ...
    <div className="text-center mb-28">
        ...
        md:text-6xl font-semibold leading-
        max-w-4xl mx-auto">
        ...
        className="text-gray-500 mx-auto text-lg mt-6 max-w-2xl"
        >
            Role-based mock interviews with smart
            follow-ups,adative difficulty and real-time performance
            and evaluation.

        </motion.p>
        <div className="gap-2 flex flex-wrap justify-center mt-10">
            <motion.button
            onClick={()=>{
            if(!userData){
                setshowAuth(true)
    ...
    gap-10 mb-28">
        ...
        `}>
            ...
            border-2 border-green-500 text-green-600 w-16 rounded-2xl flex
            items-center justify-center shadow-lg p-3 ">
            {item.icon}
            </div>
            <div className="pt-10 text-center">
                <div className="text-xs text-green-600 font-semibold nb-2">{item.step}</div>
                ...
                [
                    {
                        ...
                        desc:"Scores communication, technical and confidence.",
                    },
                    {
                        image:resumeImg,
                    ...
                    },
                    {
                        ...
                        desc:"Track with performance graphs and topic analysis",
                    },
                ].map((item,index)=>(
                    <motion.div key={index}
                    initial={{opacity:0,y:30}}
                    ...
                    rounded-3xl p-8 shadow-sm hover:shadow-xl transtion-all">
                    ...
                    gap-8">
                        ...
                        <div className="bg-green-50 text-green=600 w-12
                        h-12 rounded-xl flex items-center mb-6"></div>
                        {item.icon} </div>
                        <h3 className="font-semibold mb-3 text-xl">
                            {item.title}
                        </h3>
                        <p className="text-gray-500 text-sm leading-relxed">{item.desc}</p>
                    </div>
                    </motion.div>
